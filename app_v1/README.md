# Pediatric Suicide Methods + Ollama — Shiny App (V1)

**This is V1 — kept as a stable backup. For the latest version with main-data stats and formatting improvements, see `app_v2`.**

## Overview

This app queries the CDC injury mortality API (Socrata), shows pediatric suicide data (under 20: age groups &lt; 15 and 15–19), runs Poisson regression for year-over-year trend (total and by method), and uses Ollama Cloud to generate an AI report. You can download the report as a .docx file.
